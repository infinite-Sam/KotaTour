		...
		<c:choose>
						...
						<ul>
							<li class="dd">
								...
								<div class="dd-content">
									<a href="book_list_cate2?cate1=d&cate2=1">관광지도</a> <a
										href="book_list_cate2?cate1=d&cate2=2">월별 날씨</a> <a
										href="book_list_cate2?cate1=d&cate2=3">월별 축제</a>
								</div>
							</li>
							<li class="dd">
								<div class="dd-menu"
			...
			<c:when test="${loginMember.memberType=='1'}">
				<div id="go-login">${sessionScope.loginMember.id}님
					환영합니다. &nbsp;&nbsp;&nbsp; <a href="logoutAction">로그아웃</a> | <a
						href="memberDetailForm">마이페이지</a>
				</div>
				<div class="search3">
					<form id="searchForm" method="get">
						<select id="searchOption" class="form-control" name="searchOption">
